...
template <> constexpr inline auto StartMenu::qt_create_metaobjectdata<qt_meta_tag_ZN9StartMenuE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'continueGameClicked'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'instructionsClicked'
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->continueGameClicked(); break;
        case 2: _t->instructionsClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StartMenu::*)()>(_a, &StartMenu::newGameClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartMenu::*)()>(_a, &StartMenu::continueGameClicked, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (StartMenu::*)()>(_a, &StartMenu::instructionsClicked, 2))
            return;
    }
}
...
// SIGNAL 1
void StartMenu::continueGameClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void StartMenu::instructionsClicked()
{
